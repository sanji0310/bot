...
elseif ((strpos($result2a, "INSUFFICIENT FUNDS")) || (strpos($result2a, "insufficient funds"))){
  $status = "CVV Live 🟢";
$response = "INSUFFICIENT FUNDS ✅";

  }
elseif ((strpos($result2a, "CCN LIVE")) || (strpos($result2a, "security code is invalid")) || (strpos($result2a, "security code is incorrect"))){
  $status = "Live 🟡";
$response = "CCN LIVE ✅";
...
elseif (strpos($result2a, '"Thank you for your Payment.')){
  $status = "Live 🟢";
