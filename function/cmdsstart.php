...
if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "<b>Vinsmoke Sanji Bot
Hey @$username

</b><code>Welcome to Vinsmoke Sanji. I'm here to check your credit cards and do many stuff. Remember you can check my all commands using</code> /cmds <code>button</code>";
